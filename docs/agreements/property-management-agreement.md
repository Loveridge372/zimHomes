...
This Property Management Agreement is made on **[Agreement Date]** between:

**Owner:** [Owner Full Name / Company Name]  
...
The appointment starts on **[Start Date]** and continues until **[End Date]** or until terminated under this Agreement.

The appointment is: [Exclusive / Non-exclusive].
...
5. Prepare lease documents for signature.
6. Coordinate handover and inspection checklists.
7. Collect rent, deposits, viewing fees, or other authorised payments.
8. Follow up on late payments.
9. Coordinate maintenance requests and contractor attendance.
10. Conduct periodic inspections, if agreed.
11. Provide owner statements and payment summaries.
12. Mark listings as available, unavailable, featured, or managed.
...
The management fee is deducted from rent collected before remitting the balance to the Owner, unless the Parties agree otherwise in writing.

## 6. Additional Fees

The Owner authorises the following additional fees where applicable:

- Listing fee: USD [Amount]
- Featured listing fee: USD [Amount]
- Tenant placement fee: [Amount or Percentage]
- Lease preparation/admin fee: USD [Amount]
- Inspection fee: USD [Amount]
- Maintenance coordination fee: [Amount or Percentage]
- Other approved fee: [Description]

No unlisted fee may be charged unless approved by the Owner in writing.
...
- Account number / mobile number: [Account Details]
- Reference: [Reference]
...
1. Provide accurate property information.
2. Provide proof of ownership or authority to lease/manage the property.
...
3. Communicate material tenant issues to the Owner.
4. Seek Owner approval where required by this Agreement.
5. Avoid unauthorised use of Owner funds.
6. Protect confidential Owner and tenant information.
7. Provide periodic reports as agreed.
...
The Parties must keep private information confidential, except where disclosure is needed for property management, legal compliance, payment processing, dispute resolution, or tenant placement.
...
This Agreement and its signed annexures form the full agreement between the Parties. Any change must be in writing and signed or otherwise clearly accepted by both Parties.
...
## Annexure A: Management Setup Checklist

- Proof of ownership / authority received: [Yes / No]
- Owner ID / company documents received: [Yes / No]
- Property photos received: [Yes / No]
- Keys / access devices received: [List]
- Utility account details received: [Yes / No]
- Insurance details received: [Yes / No]
- Preferred contractor list received: [Yes / No]
